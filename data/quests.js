...
if (typeof window !== 'undefined') {
    window.QUESTS_DATABASE = QUESTS_DATABASE;
    window.getAllQuests = getAllQuests;
    window.getQuestById = getQuestById;
    window.getQuestsByDifficulty = getQuestsByDifficulty;
    window.getCompletedQuests = getCompletedQuests;
    window.getIncompleteQuests = getIncompleteQuests;
    window.getMembersQuests = getMembersQuests;
    window.getFreeToPlayQuests = getFreeToPlayQuests;
    window.getMiniquests = getMiniquests;
    window.getRegularQuests = getRegularQuests;
    window.toggleQuestCompletion = toggleQuestCompletion;
    window.saveQuestProgress = saveQuestProgress;
    window.loadQuestProgress = loadQuestProgress;
    window.getQuestProgress = getQuestProgress;
    window.getTotalQuestPoints = getTotalQuestPoints;
    window.getMaxQuestPoints = getMaxQuestPoints;
}
