...
if (typeof window !== 'undefined') {
    window.DIARIES_DATABASE = DIARIES_DATABASE;
    window.getAllDiaries = getAllDiaries;
    window.getDiaryById = getDiaryById;
    window.getDiariesByRegion = getDiariesByRegion;
    window.toggleTaskCompletion = toggleTaskCompletion;
    window.saveDiaryProgress = saveDiaryProgress;
    window.loadDiaryProgress = loadDiaryProgress;
}
